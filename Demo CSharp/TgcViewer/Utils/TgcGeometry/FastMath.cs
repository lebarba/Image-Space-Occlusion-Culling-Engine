...
namespace TgcViewer.Utils.TgcGeometry
{
    ...
    public class FastMath
    {
        ...
        /// PI / 2
        /// </summary>
        public const float PI_HALF = PI / 2.0f;
        ...
        /// <summary>
        /// Devuelve el valor mínimo entre v1, v2 y v3
        /// </summary>
        /// <param name="v1">Valor 1</param>
        /// <param name="v2">Valor 2</param>
        ...
        /// <summary>
        /// Devuelve el valor mínimo entre v1, v2, v3 y v4
        /// </summary>
        /// <param name="v1">Valor 1</param>
        /// <param name="v2">Valor 2</param>
        /// <param name="v3">Valor 3</param>
        /// <param name="v4">Valor 4</param>
        /// <returns>Mínimo valor</returns>
        ...
        /// <summary>
        /// Devuelve el valor máximo entre v1, v2 y v3
        /// </summary>
        /// <param name="v1">Valor 1</param>
        /// <param name="v2">Valor 2</param>
        /// <param name="v3">Valor 3</param>
        ...
        /// <summary>
        /// Devuelve el valor máximo entre v1, v2, v3 y v4
        /// </summary>
        /// <param name="v1">Valor 1</param>
        /// <param name="v2">Valor 2</param>
        /// <param name="v4">Valor 3</param>
        /// <param name="v4">Valor 5</param>
        /// <returns>Máximo valor</returns>
        ...
        #region Utilidades para problemas de precision numerica

        
        public static bool epsilonLess(float v1, float v2, float epsilon)
        {
            return v1 - v2 < epsilon;
        }

        public static bool epsilonLessEquals(float v1, float v2, float epsilon)
        {
            return v1 - v2 <= epsilon;
        }

        public static bool epsilonGreater(float v1, float v2, float epsilon)
        {
            return v1 - v2 > epsilon;
        }

        public static bool epsilonGreaterEquals(float v1, float v2, float epsilon)
        {
            return v1 - v2 >= epsilon;
        }
